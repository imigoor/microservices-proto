...
const file_shipping_shipping_proto_rawDesc = "" +
	"\n" +
	"\x17shipping/shipping.proto\"h\n" +
	"\x15CreateShippingRequest\x12\x19\n" +
	"\border_id\x18\x01 \x01(\x03R\aorderId\x124\n" +
	"\x0eshipping_items\x18\x02 \x03(\v2\r.ShippingItemR\rshippingItems\"M\n" +
	"\fShippingItem\x12!\n" +
	...
	"\bShipping\x12;\n" +
	"\x06Create\x12\x16.CreateShippingRequest\x1a\x17.CreateShippingResponse\"\x00B3Z1github/ruandg/microservices-proto/golang/shippingb\x06proto3"
...
var file_shipping_shipping_proto_depIdxs = []int32{
	1, // 0: CreateShippingRequest.shipping_items:type_name -> ShippingItem
